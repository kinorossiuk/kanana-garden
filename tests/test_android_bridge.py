...
class AndroidBridgeTests(unittest.TestCase):
    def test_release_and_android_versions_match(self) -> None:
        ...
        self.assertIn('versionName "0.0.1-alpha.2"', build)
        self.assertIn('version = "0.0.1a2"', package)
        self.assertIn("v0.0.1-alpha.2", release)
    ...
    def test_bridge_declares_only_required_sensitive_permission(self) -> None:
        ...
        self.assertEqual(permissions, ["android.permission.MODIFY_AUDIO_SETTINGS"])
